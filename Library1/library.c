...
void LibraryFind(Library* pl)
{
	...
	if (choice == 1)
	{
		...
		if (pl->arr[pos].is_borrowed > 0)
		{
			...
			// borrow_time and due_time removed
		}
		else
		{
			printf("\n?????: ¦Ä???\n");
